...
@XmlRootElement(name = "getAllAuteursResponse", namespace = "http://webservice.isima.fr/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getAllAuteursResponse", namespace = "http://webservice.isima.fr/")
public class GetAllAuteursResponse {
