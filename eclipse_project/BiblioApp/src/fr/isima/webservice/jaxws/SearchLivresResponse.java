...
@XmlRootElement(name = "searchLivresResponse", namespace = "http://webservice.isima.fr/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "searchLivresResponse", namespace = "http://webservice.isima.fr/")
public class SearchLivresResponse {
